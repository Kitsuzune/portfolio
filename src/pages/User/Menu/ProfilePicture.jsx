                ...
                <Row className='mt-4'>
                    <Col md={12}>
                        <div className="form-group text-center relative">
                            {selectedImage ? (
                                <img src={selectedImage} alt="Profile" className="rounded-full my-5 w-96 h-96 object-cover mx-auto" />
                            ) : currentImage ? (
                                <img src={currentImage} alt="Profile" className="rounded-full my-5 w-96 h-96 object-cover mx-auto" />
                            ) : (
                                <div className="rounded-full my-5 w-96 h-96 bg-gray-500 mx-auto flex items-center justify-center text-white text-[200px]">
                            ...
                            <input
                                ...
                                className="absolute inset-0 w-90 h-full opacity-0 cursor-pointer"
                            />
                        </div>
